"""
TB Breath Analyzer - TB Surrogate Sample Collection
Collects breath + alcohol/VOC samples for the 'TB' class.
"""
...
def collect_samples(label: str):
    ...
    print("=" * 50)
    print(f"TB Breath Analyzer - {label} Surrogate Collection")
    print("=" * 50)
    print()
    print("Surrogates: hand sanitizer, marker fumes")
    print()
